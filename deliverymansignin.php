<?php
	...
	if(isset($_POST['signin']) && isset($_POST['username']) && isset($_POST['password'])){
		...
		//Signin processing
			...
			$check_query="SELECT * FROM delivery_man WHERE Delivery_Man_ID='$username' && Password='$password'";
...
<head>
	...
	<title>Delivery Man Signin</title>
</head>
<body>
	<div class="container">
		<div class="form_body">
			<h3>Delivery Man Signin Form</h3>
			<form action="" method="POST">
				...
				Havn't account?<a href="deliverymansignup.php">Signup</a>
			</form>
